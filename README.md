...
Implementations:
* (11.5k) https://github.com/facebook/prophet Prophet https://facebook.github.io/prophet/ 
* (2k) https://github.com/alan-turing-institute/sktime A unified toolbox for machine learning with time series
* Forecast (R)

Stock price forecasting:
* (2.6k) https://github.com/huseinzol05/Stock-Prediction-Models
* (2.5k) https://github.com/borisbanushev/stockpredictionai

### Spatial data

* (2.3k) https://github.com/geopandas/geopandas Python tools for geographic data

### Audio and sound

General audio processing libraries:
* (5.4k) https://github.com/facebookresearch/wav2letter Automatic Speech Recognition Toolkit
* (3.9k) https://github.com/librosa/librosa Librosa
* (1.6k) https://github.com/MTG/essentia Essentia http://essentia.upf.edu/
* (3.4k) https://github.com/tyiannak/pyAudioAnalysis Python Audio Analysis Library: Feature Extraction, Classification, Segmentation and Applications
* (650) https://github.com/keunwoochoi/kapre keras audio preprocessor that let you calculate STFT/melspectrograms directly in your keras model on the fly without saving them in your storage
* (141) https://github.com/bmcfee/resampy Efficient sample rate conversion in python

Pitch trackers:
* (409) https://github.com/marl/crepe REPE is a monophonic pitch tracker based on a deep convolutional neural network operating directly on the time-domain waveform input. CREPE is state-of-the-art (as of 2018), outperforming popular pitch trackers such as pYIN and SWIPE https://arxiv.org/abs/1802.06182
...
Other
* (480) https://github.com/AddictedCS/soundfingerprinting audio acoustic fingerprinting fingerprinting in C# (advertising etc. - not speech)
...
* (21.7k) https://github.com/facebookresearch/fastText - Library for fast text representation and classification
* (17.2k) https://github.com/explosion/spaCy (in Cython) -  Industrial-strength Natural Language Processing (NLP) with Python and Cython https://spacy.io
* (11.2k) https://github.com/RaRe-Technologies/gensim Topic Modelling for Humans, robust semantic analysis, topic modeling and vector-space modeling
* (34k) https://github.com/huggingface/pytorch-transformers A library of state-of-the-art pretrained models for Natural Language Processing (NLP)
* (9.2k) https://github.com/nltk/nltk - NLTK
* (9.4k) https://github.com/zalandoresearch/flair A very simple framework for state-of-the-art Natural Language Processing (NLP)
* (4.4k) https://github.com/wireservice/csvkit
* (4.6k) https://github.com/deepmipt/DeepPavlov - building end-to-end dialog systems and training chatbots
...
* (6.9k) https://github.com/Zulko/moviepy - Video editing with Python
* (19.8k) https://github.com/iperov/DeepFaceLab DeepFaceLab is a tool that utilizes machine learning to replace faces in videos.

### Images

* (4k) https://github.com/scikit-image/scikit-image Image processing in Python
* (7.7k) https://github.com/python-pillow/Pillow PIL is the Python Imaging Library
* OpenCV: for images
...
* (1.4k) sod: https://github.com/symisc/sod/ An Embedded, Modern Computer Vision & Machine Learning Library
...
Databases:
* (14k) https://github.com/dgraph-io/dgraph Dgraph Fast, Distributed Graph DB https://dgraph.io/
* Neo4j
* (3.6k) Janus Graph https://janusgraph.org/ https://github.com/janusgraph/janusgraph
  JanusGraph [2] has support for a lot of different backends, built by the old team behind TitanDB
* (10.3k) https://github.com/arangodb/arangodb ArangoDB is a native multi-model database with flexible data models for documents, graphs, and key-values. Best open source graph database is ArrangoDB they have master to master cluster
...
Time series:
* (5.1k) https://github.com/blue-yonder/tsfresh
* (1.4k) https://github.com/bukosabino/ta Technical Analysis Library using Pandas (Python)
* (354) https://github.com/benfulcher/hctsa Highly comparative time-series analysis code repository
* https://github.com/chlubba/catch22 catch-22: CAnonical Time-series CHaracteristics

Feature extraction:
* (232) https://github.com/tyarkoni/pliers - Automated feature extraction in Python (audio/video)
* (5.1k) https://github.com/Featuretools/featuretools
...
Feature selection:
* (1.7k) https://github.com/WillKoehrsen/feature-selector Feature selector is a tool for dimensionality reduction of machine learning datasets.
...
* (780) https://github.com/scikit-learn-contrib/boruta_py - Python implementations of the Boruta all-relevant feature selection method
* (289) https://github.com/EpistasisLab/scikit-rebate - A scikit-learn-compatible Python implementation of ReBATE, a suite of Relief-based feature selection algorithms for Machine Learning
* (660) https://github.com/abhayspawar/featexp eature exploration for supervised learning

Hyper-parameter optimization:
* (7.5k) https://github.com/EpistasisLab/tpot Python Automated Machine Learning tool that optimizes machine learning pipelines using genetic programming
* (3.2k) https://github.com/pfnet/optuna - A hyperparameter optimization framework https://optuna.org
...
* (376) https://github.com/machinalis/featureforge - creating and testing machine learning features, with a scikit-learn compatible API

### Feature stores

* (1k) https://github.com/feast-dev/feast Feature Store for Machine Learning https://feast.dev
* (261) https://github.com/logicalclocks/hopsworks Hopsworks - Data-Intensive AI platform with a Feature Store
...
AutoML libs:
* (7.5k) https://github.com/EpistasisLab/tpot A Python Automated Machine Learning tool that optimizes machine learning pipelines using genetic programming
* (7.4k) https://github.com/keras-team/autokeras AutoML library for deep learning
* (6.9k) https://github.com/microsoft/nni An open source AutoML toolkit for automate machine learning lifecycle, including feature engineering, neural architecture search, model compression and hyper-parameter tuning
* (4.9k) https://github.com/automl/auto-sklearn Automated Machine Learning with scikit-learn
* (3.2k) https://github.com/tensorflow/adanet Fast and flexible AutoML with learning guarantees
* (3.3k) https://github.com/google/automl Google Brain AutoML
* (2.8k) https://github.com/mindsdb/mindsdb Machine Learning in one line of code
* (2.3k) https://github.com/pycaret/pycaret An open source, low-code machine learning library in Python
* (1.1k) https://github.com/AxeldeRomblay/MLBox MLBox is a powerful Automated Machine Learning python library
* (263) https://github.com/automl/autoweka
* (405) https://github.com/automl/HpBandSter a distributed Hyperband implementation on Steroids
* (235) https://github.com/shankarpandala/lazypredict Lazy Predict help build a lot of basic models without much code and helps understand which models works better without any parameter tuning
...
* (15.8k) https://github.com/celery/celery Distributed Task Queue http://celeryproject.org/
* (18.3k) https://github.com/apache/incubator-airflow https://airflow.apache.org programmatically author, schedule, and monitor workflows as directed acyclic graphs (DAGs) of tasks
* (13.7k) https://github.com/spotify/luigi build complex pipelines of (long-running) batch jobs like Hadoop jobs, Spark jobs, dumping data to/from databases, running machine learning algorithms, Python snippet etc. The dependency graph is specified within Python (not XML or JSON).
* (3.4k) https://github.com/azkaban/azkaban Azkaban workflow manager
* Oozie 
* (872) https://github.com/d6t/d6tflow - Python library for building highly effective data science workflows (on top of luigi)

ETL:
* (1.5k) https://github.com/mara/data-integration A lightweight opinionated ETL framework, halfway between plain scripts and Apache Airflow
* (1.3k) https://github.com/python-bonobo/bonobo https://www.bonobo-project.org/ Transform Load Extract for Python 3.5+ 

Stream processing:
* (1.5k) https://github.com/nerevu/riko A Python stream processing engine modeled after Yahoo! Pipes

Web scrapping
* (38.3k) https://github.com/scrapy/scrapy - create spiders bots that scan website pages and collect structured data

Machine learning training, deployment etc.
* (9.4k) https://github.com/kubeflow/kubeflow Machine Learning Toolkit for Kubernetes
* (6.5k) https://github.com/cortexlabs/cortex Cloud native model serving infrastructure. Cortex is an open source platform for deploying machine learning models as production web services

### Data labeling

* (4.2k) https://github.com/snorkel-team/snorkel Programmatically Build and Manage Training Data
...
* Reactive streams:
  ...
  * Links:
    ...
    * http://reactivex.io/ An API for asynchronous programming with observable streams:
      * (43.5k) https://github.com/ReactiveX/RxJava Reactive Extensions for the JVM – a library for composing asynchronous and event-based programs using observable sequences for the Java VM
      * (3.6k) https://github.com/ReactiveX/RxPY Reactive Extensions for Python
...
* Actor model:
  ...
  * Links:
    * (11.1k) https://github.com/akka/akka Build highly concurrent, distributed, and resilient message-driven applications on the JVM
    * (11.4k) https://github.com/eclipse-vertx/vert.x Vert.x is a tool-kit for building reactive applications on the JVM
    * (1.9k) https://github.com/quantmind/pulsar/ Event driven concurrent framework for Python https://quantmind.github.io/pulsar/index.html Pulsar implements two layers of components on top of python asyncio module: the actor layer and the application framework
    * (904) https://github.com/jodal/pykka Python implementation of the actor model, which makes it easier to build concurrent applications
    * (133) https://github.com/kquick/Thespian Python Actor concurrency library
...
Event loops: 
* (15.8k) https://github.com/libuv/libuv Cross-platform asynchronous I/O
* (6.6k) https://github.com/libevent/libevent Event notification library
* (959) https://github.com/enki/libev Full-featured high-performance event loop loosely modelled after libevent
* Python asyncio: https://github.com/timofurrer/awesome-asyncio 

### Async networking libraries

* (5.3k) https://github.com/gevent/gevent coroutine - based Python networking library. "systems like gevent use lightweight threads to offer performance comparable to asynchronous systems, but they do not actually make things asynchronous"
  * greenlet to provide a high-level synchronous API 
    * on top of the libev or libuv event loop (like libevent)

* (957) https://github.com/eventlet/eventlet concurrent networking library for Python
  * epoll or kqueue or libevent for highly scalable non-blocking I/O

* (10.3k) https://github.com/aio-libs/aiohttp Asynchronous HTTP client/server framework for asyncio and Python

* (4k) https://github.com/twisted/twisted Event-driven networking engine written in Python. 
...
* (19.4k) https://github.com/tornadoweb/tornado Python web framework and asynchronous networking library 
...
* (14.1k) https://github.com/huge-success/sanic Sanic
* (21.1k) https://github.com/tiangolo/fastapi FastAPI
...
Retry libraries:
* (2.5k) https://github.com/jd/tenacity - originates from a fork of retrying
* (1.6k) https://github.com/rholder/retrying - not supported anymore
* (1.3k) https://github.com/litl/backoff
* (335) https://github.com/invl/retry
* (233) https://github.com/channable/opnieuw
...
* h5py (1.4k): https://github.com/h5py/h5py HDF5 for Python -- The h5py package is a Pythonic interface to the HDF5 binary data format

### Authentication, Authorization, Security

Identity and Access Management
  * (7.1k) https://github.com/keycloak/keycloak
  * (9.3k) https://github.com/ory/hydra OAuth2 Server and OpenID Certified™ OpenID Connect Provider written in Go - cloud native, security-first, open source API security for your infrastructure. SDKs for any language
  * (3.4k) https://github.com/jpadilla/pyjwt JSON Web Token implementation in Python
  * (3.2k) https://github.com/apache/shiro Apache Shiro is a powerful and easy-to-use Java security framework that performs authentication, authorization, cryptography, and session management
  * (2k) https://github.com/lepture/authlib The ultimate Python library in building OAuth, OpenID Connect clients and servers. JWS,JWE,JWK,JWA,JWT included
  * (519) https://github.com/OpenIDC/pyoidc/ A Python OpenID Connect implementation
  * (1.6k) https://github.com/RichardKnop/go-oauth2-server A standalone, specification-compliant, OAuth2 server written in Golang. 
  * https://www.gluu.org/
...
Secrets management, encryption as a service, and privileged access management. A secret is anything that you want to tightly control access to, such as API keys, passwords, certificates, and more.
  * (18.1k) https://github.com/hashicorp/vault A tool for secrets management, encryption as a service, and privileged access management
...
Policy Enforcement Point, Identity And Access Proxy (IAP), Zero-Trust Network Architecture, i.e. a reverse proxy in front of your upstream API or web server that rejects unauthorized requests and forwards authorized ones to your server. 
  * (1.9k) https://github.com/ory/oathkeeper ORY Oathkeeper 
...
* (7.2k) https://github.com/dask/dask Parallel computing with task scheduling
* (5k) https://github.com/vaexio/vaex Out-of-Core DataFrames for Python, ML, visualize and explore big tabular data at a billion rows per second
* (1.1k) https://github.com/dask/distributed distributed dask
* (13.2k) https://github.com/ray-project/ray A system for parallel and distributed Python that unifies the ML ecosystem (similar to Dask)
* (3.2k) https://github.com/arrayfire/arrayfire a general purpose GPU library
