...
Implementations:
* (11.9k) https://github.com/facebook/prophet Prophet https://facebook.github.io/prophet/ 
* (669) https://github.com/ourownstory/neural_prophet Neural Network based Time-Series model
* (2.6k) https://github.com/alan-turing-institute/sktime A unified toolbox for machine learning with time series
* Forecast (R)

Stock price forecasting:
* (2.9k) https://github.com/huseinzol05/Stock-Prediction-Models
* (2.6k) https://github.com/borisbanushev/stockpredictionai

### Spatial data

* (2.4k) https://github.com/geopandas/geopandas Python tools for geographic data

### Audio and sound

General audio processing libraries:
* (5.5k) https://github.com/facebookresearch/wav2letter Automatic Speech Recognition Toolkit
* (4.1k) https://github.com/librosa/librosa Librosa
* (1.7k) https://github.com/MTG/essentia Essentia http://essentia.upf.edu/
* (3.6k) https://github.com/tyiannak/pyAudioAnalysis Python Audio Analysis Library: Feature Extraction, Classification, Segmentation and Applications
* (680) https://github.com/keunwoochoi/kapre keras audio preprocessor that let you calculate STFT/melspectrograms directly in your keras model on the fly without saving them in your storage
* (147) https://github.com/bmcfee/resampy Efficient sample rate conversion in python

Pitch trackers:
* (453) https://github.com/marl/crepe REPE is a monophonic pitch tracker based on a deep convolutional neural network operating directly on the time-domain waveform input. CREPE is state-of-the-art (as of 2018), outperforming popular pitch trackers such as pYIN and SWIPE https://arxiv.org/abs/1802.06182
...
Other
* (512) https://github.com/AddictedCS/soundfingerprinting audio acoustic fingerprinting fingerprinting in C# (advertising etc. - not speech)
...
* (22k) https://github.com/facebookresearch/fastText - Library for fast text representation and classification
* (17.7k) https://github.com/explosion/spaCy (in Cython) -  Industrial-strength Natural Language Processing (NLP) with Python and Cython https://spacy.io
* (11.4k) https://github.com/RaRe-Technologies/gensim Topic Modelling for Humans, robust semantic analysis, topic modeling and vector-space modeling
* (37.6k) https://github.com/huggingface/pytorch-transformers A library of state-of-the-art pretrained models for Natural Language Processing (NLP)
* (9.5k) https://github.com/nltk/nltk - NLTK
* (9.6k) https://github.com/zalandoresearch/flair A very simple framework for state-of-the-art Natural Language Processing (NLP)
* (4.4k) https://github.com/wireservice/csvkit
* (4.9k) https://github.com/deepmipt/DeepPavlov - building end-to-end dialog systems and training chatbots
...
* (7.1k) https://github.com/Zulko/moviepy - Video editing with Python
* (21.6k) https://github.com/iperov/DeepFaceLab DeepFaceLab is a tool that utilizes machine learning to replace faces in videos.
...
Databases:
* (14.4k) https://github.com/dgraph-io/dgraph Dgraph Fast, Distributed Graph DB https://dgraph.io/
* Neo4j
* (3.7k) https://github.com/janusgraph/janusgraph https://janusgraph.org/ 
  JanusGraph [2] has support for a lot of different backends, built by the old team behind TitanDB
* (10.6k) https://github.com/arangodb/arangodb ArangoDB is a native multi-model database with flexible data models for documents, graphs, and key-values. Best open source graph database is ArrangoDB they have master to master cluster
...
Time series:
* (5.2k) https://github.com/blue-yonder/tsfresh
* (1.6k) https://github.com/bukosabino/ta Technical Analysis Library using Pandas (Python)
* (355) https://github.com/benfulcher/hctsa Highly comparative time-series analysis code repository
* https://github.com/chlubba/catch22 catch-22: CAnonical Time-series CHaracteristics

Feature extraction:
* (236) https://github.com/tyarkoni/pliers - Automated feature extraction in Python (audio/video)
* (5.2k) https://github.com/Featuretools/featuretools
...
* (830) https://github.com/scikit-learn-contrib/boruta_py - Python implementations of the Boruta all-relevant feature selection method
* (302) https://github.com/EpistasisLab/scikit-rebate - A scikit-learn-compatible Python implementation of ReBATE, a suite of Relief-based feature selection algorithms for Machine Learning
* (673) https://github.com/abhayspawar/featexp eature exploration for supervised learning

Hyper-parameter optimization:
* (7.7k) https://github.com/EpistasisLab/tpot Python Automated Machine Learning tool that optimizes machine learning pipelines using genetic programming
* (3.7k) https://github.com/pfnet/optuna - A hyperparameter optimization framework https://optuna.org
...
* (1.2k) https://github.com/feast-dev/feast Feature Store for Machine Learning https://feast.dev
* (328) https://github.com/logicalclocks/hopsworks Hopsworks - Data-Intensive AI platform with a Feature Store
...
AutoML libs:
* (7.7k) https://github.com/EpistasisLab/tpot A Python Automated Machine Learning tool that optimizes machine learning pipelines using genetic programming
* (7.6k) https://github.com/keras-team/autokeras AutoML library for deep learning
* (8.4k) https://github.com/microsoft/nni An open source AutoML toolkit for automate machine learning lifecycle, including feature engineering, neural architecture search, model compression and hyper-parameter tuning
* (5k) https://github.com/automl/auto-sklearn Automated Machine Learning with scikit-learn
* (3.2k) https://github.com/tensorflow/adanet Fast and flexible AutoML with learning guarantees
* (3.6k) https://github.com/google/automl Google Brain AutoML
* (3.1k) https://github.com/mindsdb/mindsdb Machine Learning in one line of code
* (2.6k) https://github.com/pycaret/pycaret An open source, low-code machine learning library in Python
* (1.2k) https://github.com/AxeldeRomblay/MLBox MLBox is a powerful Automated Machine Learning python library
* (268) https://github.com/automl/autoweka
* (426) https://github.com/automl/HpBandSter a distributed Hyperband implementation on Steroids
* (242) https://github.com/shankarpandala/lazypredict Lazy Predict help build a lot of basic models without much code and helps understand which models works better without any parameter tuning
...
* (7.9k) https://github.com/spotify/annoy 
...
* (16.3k) https://github.com/celery/celery Distributed Task Queue http://celeryproject.org/
* (19.5k) https://github.com/apache/airflow https://airflow.apache.org programmatically author, schedule, and monitor workflows as directed acyclic graphs (DAGs) of tasks
* (14k) https://github.com/spotify/luigi build complex pipelines of (long-running) batch jobs like Hadoop jobs, Spark jobs, dumping data to/from databases, running machine learning algorithms, Python snippet etc. The dependency graph is specified within Python (not XML or JSON).
* (3.5k) https://github.com/azkaban/azkaban Azkaban workflow manager
* Oozie 
* (884) https://github.com/d6t/d6tflow - Python library for building highly effective data science workflows (on top of luigi)
...
Web scrapping
* (39.1k) https://github.com/scrapy/scrapy - create spiders bots that scan website pages and collect structured data

Machine learning training, deployment etc.
* (9.7k) https://github.com/kubeflow/kubeflow Machine Learning Toolkit for Kubernetes
* (6.9k) https://github.com/cortexlabs/cortex Cloud native model serving infrastructure. Cortex is an open source platform for deploying machine learning models as production web services

### Data labeling

* (4.3k) https://github.com/snorkel-team/snorkel Programmatically Build and Manage Training Data
...
* Reactive streams:
  ...
  * Links:
    ...
    * http://reactivex.io/ An API for asynchronous programming with observable streams:
      * (43.8k) https://github.com/ReactiveX/RxJava Reactive Extensions for the JVM – a library for composing asynchronous and event-based programs using observable sequences for the Java VM
      * (3.7k) https://github.com/ReactiveX/RxPY Reactive Extensions for Python
...
* Actor model:
  ...
  * Links:
    * (11.2k) https://github.com/akka/akka Build highly concurrent, distributed, and resilient message-driven applications on the JVM
    * (11.5k) https://github.com/eclipse-vertx/vert.x Vert.x is a tool-kit for building reactive applications on the JVM
    ...
    * (921) https://github.com/jodal/pykka Python implementation of the actor model, which makes it easier to build concurrent applications
    * (139) https://github.com/kquick/Thespian Python Actor concurrency library
...
Event loops: 
* (16.3k) https://github.com/libuv/libuv Cross-platform asynchronous I/O
* (6.9k) https://github.com/libevent/libevent Event notification library
* (993) https://github.com/enki/libev Full-featured high-performance event loop loosely modelled after libevent
...
* (982) https://github.com/eventlet/eventlet concurrent networking library for Python
  * epoll or kqueue or libevent for highly scalable non-blocking I/O

* (10.5k) https://github.com/aio-libs/aiohttp Asynchronous HTTP client/server framework for asyncio and Python
...
* (19.6k) https://github.com/tornadoweb/tornado Python web framework and asynchronous networking library 
...
* (14.3k) https://github.com/huge-success/sanic Sanic
* (23.8k) https://github.com/tiangolo/fastapi FastAPI
...
Retry libraries:
* (2.6k) https://github.com/jd/tenacity - originates from a fork of retrying
* (1.6k) https://github.com/rholder/retrying - not supported anymore
* (1.4k) https://github.com/litl/backoff
* (351) https://github.com/invl/retry
* (240) https://github.com/channable/opnieuw
...
Identity and Access Management
  * (7.7k) https://github.com/keycloak/keycloak
  * (9.6k) https://github.com/ory/hydra OAuth2 Server and OpenID Certified™ OpenID Connect Provider written in Go - cloud native, security-first, open source API security for your infrastructure. SDKs for any language
  * (3.5k) https://github.com/jpadilla/pyjwt JSON Web Token implementation in Python
  ...
  * (2.2k) https://github.com/lepture/authlib The ultimate Python library in building OAuth, OpenID Connect clients and servers. JWS,JWE,JWK,JWA,JWT included
  * (537) https://github.com/OpenIDC/pyoidc A Python OpenID Connect implementation
...
Secrets management, encryption as a service, and privileged access management. A secret is anything that you want to tightly control access to, such as API keys, passwords, certificates, and more.
  * (18.7k) https://github.com/hashicorp/vault A tool for secrets management, encryption as a service, and privileged access management
...
* (7.6k) https://github.com/dask/dask Parallel computing with task scheduling
* (5.4k) https://github.com/vaexio/vaex Out-of-Core DataFrames for Python, ML, visualize and explore big tabular data at a billion rows per second
* (1.1k) https://github.com/dask/distributed distributed dask
* (14k) https://github.com/ray-project/ray A system for parallel and distributed Python that unifies the ML ecosystem (similar to Dask)
